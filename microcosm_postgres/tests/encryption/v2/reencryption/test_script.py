...
def find_instances(model: Any, client_id: UUIDType, search_kwargs: dict) -> Iterator[Model]:
    """
...
def reencrypt_model(session: Session, model_with_encryption: ModelWithEncryptionSearch, client_id: UUIDType) -> None:
    """
